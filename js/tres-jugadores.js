...
const jugar = () => {
    if(jugadores[0].length < 1 && jugadores[1].length < 1 && jugadores[2].length < 1){
        mezclarMazo();
        let carta;
        let bandera = false;
...
const actualizarUsuario = (jugador) => {
    ...
    if(jugador === 0){
        ...
        usuario.experiencia = usuario.experiencia + 750
    } else if(jugador === 1){
        usuario.partidasGanadas = usuario.partidasGanadas + 1
        usuario.experiencia = usuario.experiencia + 1500
    }
...
const revisarCantidadCartas = () => {
    ...
    if(jugadores[0].length < jugadores[1].length && jugadores[0].length < jugadores[2].length){
        jugadorConMenosCartas = 0;
    } else if(jugadores[1].length < jugadores[0].length && jugadores[1].length < jugadores[2].length){
        jugadorConMenosCartas = 1;
    } else if(jugadores[2].length < jugadores[0].length && jugadores[2].length < jugadores[1].length){
